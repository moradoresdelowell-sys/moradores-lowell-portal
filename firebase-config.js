...
window.criarDestaquesFake = async () => {
  ...
  batch.set(dest.doc("1"), { 
    titulo: "Estabelecimento 1", 
    descricao: "Breve descrição do estabelecimento e seus serviços.", 
    endereco: "Endereço", 
    telefone: "(978) 555-0001",
    imagem: "https://via.placeholder.com/300x200?text=Premium+1", 
    destaque: true 
  });
  batch.set(dest.doc("2"), { 
    titulo: "Estabelecimento 2", 
    descricao: "Breve descrição do estabelecimento e seus serviços.", 
    endereco: "Endereço", 
    telefone: "(978) 555-0002",
    imagem: "https://via.placeholder.com/300x200?text=Premium+2", 
    destaque: true 
  });
  batch.set(dest.doc("3"), { 
    titulo: "Estabelecimento 3", 
    descricao: "Breve descrição do estabelecimento e seus serviços.", 
    endereco: "Endereço", 
    telefone: "(978) 555-0003",
    imagem: "https://via.placeholder.com/300x200?text=Premium+3", 
    destaque: true 
  });
  await batch.commit();
...
window.criarAdmin = async () => {
  ...
  await admins.set({ usuario: "admin@moradores.com", senha: "123456" });
  alert("Admin criado! Login: admin@moradores.com / senha: 123456");
};